...
function parametersSave() {
	showMessage("ss Un moment s'il vous plait, en cours de sauvegarde ...");
	var _data = "";
	_data += "&PAR_RAPPORT=ars3_rpt_activ";
	...
	var _fex = "ars3_parameters_save_dbact";
...
function parametersLoad() {
	...
	var _fex = "ars3_parameters_load_dbact";
