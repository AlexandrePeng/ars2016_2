function geo_check()
{
if(this.ars3_listb_geo[0].selected)
 {
 this.ars3_listb_geo_regnw.disabled=true;
 //this.ars3_listb_geo_reg.disabled=true;
 this.ars3_listb_geo_dept.disabled=true;
 }
 if (this.ars3_listb_geo[1].selected)
 {
 this.ars3_listb_geo_regnw.disabled=false;
 //this.ars3_listb_geo_reg.disabled=true;
 this.ars3_listb_geo_dept.disabled=true;
 }
  if (this.ars3_listb_geo[2].selected){
  this.ars3_listb_geo_regnw.disabled=false;
  //this.ars3_listb_geo_reg.disabled=false;
  this.ars3_listb_geo_dept.disabled=false;
  }
 }
 
function activite_check()
{
 if(this.ars3_listb_act[0].selected)
 {
 this.ars3_listb_act_sect.disabled=true;
 this.ars3_listb_act_tint.disabled=true;
 this.ars3_listb_act_miss.disabled=true;
 }
 if (this.ars3_listb_act[1].selected)
 {
 this.ars3_listb_act_sect.disabled=false;
 this.ars3_listb_act_tint.disabled=true;
 this.ars3_listb_act_miss.disabled=true;
 }
 if (this.ars3_listb_act[2].selected){
 this.ars3_listb_act_sect.disabled=false;
 this.ars3_listb_act_tint.disabled=false;
 this.ars3_listb_act_miss.disabled=true;
  }
 if (this.ars3_listb_act[3].selected){
 this.ars3_listb_act_sect.disabled=false;
 this.ars3_listb_act_tint.disabled=false;
 this.ars3_listb_act_miss.disabled=false;
  }
}
...
{
	if(this.ars3_listb_categ[0].selected)
	{
 		this.ars3_listb_statut.disabled=true;	
 		this.ars3_listb_emploi.disabled=true;
	}
	if (this.ars3_listb_categ[1].selected)
	{
		this.ars3_listb_statut.disabled=false;
		this.ars3_listb_emploi.disabled=true;
	}
	if (this.ars3_listb_categ[2].selected)
		{
			this.ars3_listb_statut.disabled=false;
			this.ars3_listb_emploi.disabled=false;
	}
}
 
//function site_check()
//{
//	if(this.ars3_listb_site[0].selected)
//	{
// 		this.ars3_listb_site_site.disabled=true;	
//	}
//	if (this.ars3_listb_site[1].selected)
//	{
//		this.ars3_listb_site_site.disabled=false;
//	}
//}
